...
def build_candidate(decision: dict[str, object]) -> dict[str, object]:
    return {
        ...
        "target_behavior": "Make the next food action deliberate, available, and aligned with the current nutrition strategy.",
        "environment_design": "Select from available food options before hunger, time pressure, or convenience causes reactive ordering.",
        "duration": "20 min",
