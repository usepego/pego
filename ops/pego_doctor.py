...
REQUIRED_FILES = [
    ...
    "pego/tools/README.md",
    "pego/tools/calendar.availability.md",
    "pego/tools/food.environment.lookup.md",
    "pego/tools/finance.scenario_model.md",
    "pego/tools/finance.portfolio_analyze.md",
    "pego/tools/governance.preflight.md",
    "pego/tools/execution.financial_trade.md",
    ...
    "pego/operations/recommendation-adoption.md",
    "pego/operations/recommendation-quality-loop.md",
    "pego/operations/scenario-benchmarks.md",
    "pego/operations/domain-baseline-bootstrap.md",
    "pego/operations/goal-reconciliation.md",
    "pego/operations/state-inputs.md",
    ...
    "pego/operations/circumstance-update.md",
    ...
    "pego/operations/attention-governance.md",
    ...
    "pego/schemas/operating-brief.schema.json",
    "pego/schemas/intra-day-session-log.schema.json",
    "pego/schemas/session-review.schema.json",
    ...
    "pego/schemas/council-decision.schema.json",
    ...
    "pego/schemas/private-storage-readiness.schema.json",
    ...
    "pego/schemas/attention-option.schema.json",
    "pego/schemas/attention-decision.schema.json",
    "pego/schemas/tool-contract.schema.json",
    "pego/schemas/behavior-loop.schema.json",
    "pego/schemas/scenario-benchmark.schema.json",
    "pego/templates/agent-recommendation.md",
    "pego/templates/agent-recommendation-review.md",
    "pego/templates/agent-calibration-record.md",
    ...
    "pego/templates/memory-lifecycle-review.md",
    ...
    "pego/templates/council-synthesis-review.md",
    ...
    "pego/templates/tool-contract.md",
    "pego/templates/behavior-loop.md",
    ...
    "ops/attention/test_decide_attention.py",
    ...
    "ops/evaluation/run_scenario_benchmarks.py",
    "ops/evaluation/test_run_scenario_benchmarks.py",
    ...
    "ops/goals/reconcile_goals.py",
    "ops/goals/test_reconcile_goals.py",
    "ops/goals/update_goal_progress.py",
    "ops/goals/test_update_goal_progress.py",
    "ops/loops/detect_behavior_loops.py",
    "ops/loops/test_detect_behavior_loops.py",
    "ops/state/record_state_signal.py",
    "ops/state/test_record_state_signal.py",
    "ops/operator/next_step.py",
    "ops/operator/test_next_step.py",
    "ops/operator/generate_brief.py",
    "ops/operator/test_generate_brief.py",
    "ops/operator/close_session.py",
    ...
    "ops/finance/test_generate_check_in.py",
    ...
    "ops/private/guide_operation.py",
    "ops/private/test_guide_operation.py",
    "ops/schema_validation.py",
    "ops/test_schema_contracts.py",
    "ops/run_smoke_tests.py",
...
SCHEMA_FILES = sorted(
    str(path.relative_to(ROOT)) for path in (ROOT / "pego" / "schemas").glob("*.schema.json")
)
